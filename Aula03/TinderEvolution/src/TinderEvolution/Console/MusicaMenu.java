...
import TinderEvolution.Dominio.EstiloMusical;
import TinderEvolution.Dominio.Musica;
import TinderEvolution.Gerenciador.MusicaGerenciador;
...
public class MusicaMenu {
    ...
    private Musica inserirDadosMusica() {
    ...
    public Musica create() {
        ...
        Musica musica = inserirDadosMusica();
    ...
    public Musica editar() {
        ...
        Musica atualizacao = inserirDadosMusica();
